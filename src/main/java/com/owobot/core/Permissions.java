...
public enum Permissions {
    ...
    // Text permissions,
    MESSAGE_READ("text.read_messages", Permission.MESSAGE_HISTORY),
    MESSAGE_WRITE("text.send_messages", Permission.MESSAGE_SEND),
    ...
    MESSAGE_SEND_IN_THREAD("text.send_in_thread", Permission.MESSAGE_SEND_IN_THREADS),
